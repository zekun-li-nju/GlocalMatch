...
def get_config():
    ...
    parser.add_argument('-nul', '--num_unlabeled', type=int, default=None,
                        help='None means using all unlabeled data')
    ...
    parser.add_argument('--single-base', type=str2bool, default='False')
    parser.add_argument('--all-out', type=str2bool, default='False')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.distributed:
        ...
        ngpus_per_node = torch.cuda.device_count()  # number of gpus of each node
        args.all_batch_size = args.batch_size
