...
def get_cifarstl(args, alg, num_labels, data_dir='./data'):
    ...
    cifar_train_data, cifar_train_targets = make_dataset(cifar_train_dir, class_to_idx)
    cifar_test_data, cifar_test_targets = make_dataset(cifar_test_dir, class_to_idx)

    stl_train_dir = os.path.join(data_dir, 'cifarstl/stl/train')
    stl_test_dir = os.path.join(data_dir, 'cifarstl/stl/test')
    stl_train_data, stl_train_targets = make_dataset(stl_train_dir, class_to_idx)
    stl_test_data, stl_test_targets = make_dataset(stl_test_dir, class_to_idx)
